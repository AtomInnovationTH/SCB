...
export const Events = {
  ...
  LASSO_STOWED:           'lasso:stowed',    // { debrisId, podIndex } — S13(d): catch reeled in, adopting onto the nose-collar berth (the one holding model); no cellIndex exists anymore

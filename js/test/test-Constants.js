...
describe('ST-9.4a NET_TERMINOLOGY + new flags', () => {
    ...
    it('FEATURE_FLAGS has exactly 38 entries', () => {
        assert.equal(Object.keys(Constants.FEATURE_FLAGS).length, 38,
            'Expected 38 FEATURE_FLAGS (34 prior + LASSO_NET_KINEMATICS + LASSO_REEL_PHYSICS + MOTHER_CARGO_STOW + MANUAL_NAV)');
    });
